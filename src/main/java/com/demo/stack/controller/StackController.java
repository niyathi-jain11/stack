...
public class StackController {
	...
	public ResponseEntity<Employee> pushEmployee(@RequestBody Employee stack) {
		return ResponseEntity.ok().body(this.stackService.pushEmployee(stack));
	}
	...
	public HttpStatus popEmployee(@PathVariable long id) {
		this.stackService.popEmployee(id);
	...
	public ResponseEntity<Employee> updateEmployee(@PathVariable long id, @RequestBody Employee stack) {
		stack.setId(id);
		return ResponseEntity.ok().body(this.stackService.updateEmployee(stack));
	}
